...
function Navbar({ active, setText }: INavProp) {
    const navigate = useNavigate()
    const dispatch = useDispatch();
    return (
        <nav className="bg-white shadow-[0_8px_30px_rgb(0,0,0,0.12)] border-gray-200 dark:bg-gray-900 relative">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
                    ...
                    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
                            <Link to="/home" className={`block py-2 pl-3 pr-4 ${active === "home" ? "text-blue-700" : "text-black"} bg-blue-600 rounded md:bg-transparent md:p-0 md:dark:text-blue-500`} aria-current="page">Home</Link>
                        </li>
                        <li>
                            <Link to="/add" className={`block py-2 pl-3 pr-4 ${active === "addTask" ? "text-blue-700" : "text-black"} rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700`}>Add Task</Link>
                        </li>
                        <li>
                            <Link to="/bin" className={`block py-2 pl-3 pr-4 ${active === "bin" ? "text-blue-700" : "text-black"} rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700`}>Bin</Link>
                        </li>
                    </ul>
                </div>
